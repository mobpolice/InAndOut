...
<tr>
  <td>신고일자</td>
  <td>
    <fmt:parseDate var="parsedDate" value="${dto.report_date}" pattern="yyyy-MM-dd HH:mm:ss.S" />
		...
		<tr>
			...
			<tr>
				<td colspan="3" align="right">
					<button onclick="location.href='userreportlist.do' ">닫기</button>
				</td>
			</tr>
			...
			<div id="sMyModal" class="modal">
			  <div class="modal-content">
			  	<form action="ad.ublind.do" method = "post" onsubmit="return confirmSubmit()">
			...
			<div id="sYourModal" class="modal">
			  <div class="modal-content">
			  	<form action="ad.ublind.go" method = "post" onsubmit="return confirmSubmit2()">
			    <div class="modal-header">
			      <span class="close">&times;</span>
			      <h2>처리자 ${loginId}</h2>
			      <input type = "text" name="report_id" id="report_id" value="${dto.report_id}" hidden/>
