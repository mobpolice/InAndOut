...
<body>
	<div class="isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
	    ...
	    <div class="mx-auto max-w-2xl text-center">
			<h2 class="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">갤러리 수정</h2>
			<p class="mt-2 text-lg leading-8 text-gray-600">* 필수 입력 항목</p>
		</div>
	    <form action="galleryUpdate.do" method="post" enctype="multipart/form-data" class="mx-auto mt-16 max-w-xl sm:mt-20">
			<div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
				<input type="text" name="gallery_no" value="${detailData.gallery_no }" readonly="readonly" hidden="true" required/>
				<input type="text" name="user_id" value="${detailData.user_id }" readonly="readonly" hidden="true" required/>
		        <div class="sm:col-span-2">
					<label for="store_name" class="block text-sm font-semibold leading-6 text-gray-900">*상호명</label>
					<div class="mt-2.5">
						<input type="text" name="store_name" value="${detailData.store_name }" maxlength="29" onkeyup="counter(event, '30')" required class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
						<div>
