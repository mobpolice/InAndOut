...
<body>
	<div class="isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
	    ...
	    <div class="mx-auto max-w-2xl text-center">
			<h2 class="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">판매글 신고</h2>
			<p class="mt-2 text-lg leading-8 text-gray-600">* 필수 입력 항목</p>
		</div>
		<div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
	        <div class="sm:col-span-2">
				<label for="subject" class="block text-sm font-semibold leading-6 text-gray-900">신고 판매글 번호</label>
				<div class="mt-2.5">
					<input type="text" name="report_whom" id="report_whom" value="${sales_no}" required readonly="readonly" class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
				</div>
	        </div>
	        <div class="sm:col-span-2">
